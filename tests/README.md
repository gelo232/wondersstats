...
| `modals.js` | Ouverture, rendu et fermeture de chacune des 23 modales, absence de fuite d'état entre modales, saisie manuelle du numéro et refus d'un doublon. Puis le **retrait en lot de la convocation** : retirer plusieurs athlètes d'un coup, l'avertissement qui nomme ce que le retrait emporte, un vidage complet qui ne laisse aucune référence orpheline (effectif, compteurs, vues) sans toucher à la base du club, et une seule ligne de journal |
